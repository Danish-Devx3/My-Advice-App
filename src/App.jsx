...
function App() {
  ...
  return (
   ...
   <div className="flex justify-center items-center h-[100vh] bg-[url('./assets/home.png')] ">
    <div className="flex gap-9 flex-col items-center justify-center text-center isolate aspect-video w-[35%] rounded-xl bg-white/20 shadow-lg ring-1 ring-black/5">
